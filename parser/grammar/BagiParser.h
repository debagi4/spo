...
class  BagiParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    ...
    RuleArgDefList = 4, RuleArgDef = 5, RuleTypeRef = 6, RuleBaseType = 7, 
    RuleBuiltinType = 8, RuleCustomType = 9, RuleArraySuffix = 10, RuleStatement = 11, 
    RuleVarDecl = 12, RuleVarList = 13, RuleVarItem = 14, RuleIfStatement = 15, 
    RuleBlock = 16, RuleWhileStatement = 17, RuleDoWhileStatement = 18, 
    RuleBreakStatement = 19, RuleContinueStatement = 20, RuleExprStatement = 21, 
    RuleExpr = 22, RuleAssignOp = 23, RuleUnOp = 24, RuleExprList = 25, 
    RuleLiteral = 26
  };

  explicit BagiParser(antlr4::TokenStream *input);

  BagiParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  class  ArgDefListContext : public antlr4::ParserRuleContext {
  public:
    ArgDefListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    std::vector<ArraySuffixContext *> arraySuffix();
    ArraySuffixContext* arraySuffix(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<VarItemContext *> varItem();
    VarItemContext* varItem(size_t i);
  ...
  class  VarItemContext : public antlr4::ParserRuleContext {
  public:
    VarItemContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *IDENTIFIER();
    ExprContext *expr();
  ...
  class  IndexerExprContext : public ExprContext {
  public:
    IndexerExprContext(ExprContext *ctx);
  ...
  class  PlaceExprContext : public ExprContext {
  public:
    PlaceExprContext(ExprContext *ctx);
